...
<script>
	...
	$(function(){
		...
		pf_completionForm = $('#pf_completionForm');
		pf_workOnForm = $('#pf_workOnForm');
		pf_ulTag = $("#pf_gall_ul");
		pagingArea = $("#pagingArea");
        var queryString = $(this).serialize();
        
        $.ajax({
        	url:"${cPath}/order/adminOrder_produceList",
        	method : "get",
	        data : queryString,
	        dataType : "json",
        ...
        pf_completionForm.on("submit", function(event){
        	event.preventDefault();
        	var queryString = $(this).serialize();
        	console.log(queryString);
        	$.ajax({
            	url:"${cPath}/order/completion",
            	method : "get",
    	        data : queryString,
    	        dataType : "json",
    	        success : function(resp){
