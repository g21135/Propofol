...
<script>
	$(function() {
		...
		modifyBtn.on("click", function(){
			location.href = "${cPath}/infoSharing/update/" + post_num; 
		});
	...
	<input type="hidden" id="post_num" value="${postVO.post_num}">
	    ...
	    <div id="notice_v_top">
	        <ul class="notice_v_com">
				<li><a href="${cPath}/infoSharing" class="list_btn btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
			</ul>
...
<!-- 게시글 삭제 폼 -->
<form action="${cPath}/infoSharing/delete" id="BoarddeleteForm" method="post">
