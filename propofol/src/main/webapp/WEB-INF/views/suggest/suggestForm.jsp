...
<span style="font-size: 2.0em;">건의 작성</span>
<section id="notice_w">
	<form id="postForm" method="post" enctype="multipart/form-data" style="width:80%">
	    ...
	    <input type="hidden" name="board_num" value="6">
	
	    <div class="notice_w_ico notice_w_tit notice_write_div">
	        <label for="customer_question" class="no_icon"><i class="fa fa-file"></i></label>
	        <input type="text" name="customer_question" value="${customer.customer_question}" id="customer_question" class="notice_frm_input full_input required" size="50" maxlength="255" placeholder="건의">
...
<script type="text/javascript">
	...
	$("#cancle_btn").on("click", function() {
		...
		location.href = "${cPath}/suggest/" + customer_num; 
	})
